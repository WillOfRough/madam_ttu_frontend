...
const OATH_ITEMS = [
  '매칭 과정에서 취득한 Client의 개인정보(이름, 연락처, 사진 등)를 제3자에게 무단으로 제공하거나 유출하지 않겠습니다.',
  '수집된 개인정보는 매칭 목적 이외의 용도로 사용하지 않겠습니다.',
  '매칭이 종료되거나 Client가 탈퇴를 요청한 경우, 관련 정보를 지체 없이 삭제하겠습니다.',
  ...
  return (
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <h1 className={styles.title}>Client 정보 보호 서약</h1>
