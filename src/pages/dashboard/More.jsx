...
import { Link2, Sparkles, Inbox, BookOpen, Settings, ChevronRight } from 'lucide-react';
...
const ROWS = [
  ...
  { key: 'settings',    to: '/dashboard/settings',    icon: Settings,    label: '설정',       sub: '내 정보 · 정산' },
];
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.list}>
        {ROWS.map(({ key, to, icon: Icon, label, sub, badgeKey }) => {
