...
const GUIDE_SECTIONS = [
  {
    ...
    steps: [
      ...
      {
        title: '결제 금액 설정',
        desc: 'Knots & Links의 기본 정책 금액인 19,900원이 기본값으로 설정되어 있어요. 회원 상황에 맞춰 세 가지 중 선택할 수 있습니다.',
        tip: '① 기본(19,900원) ② 무료 — 이벤트로 유입된 회원에게 적용 ③ 직접 입력 — 50% 할인 등 자유롭게 금액을 입력할 때 사용해요.',
      },
      {
        title: '매칭 생성 완료',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: '초대권은 단 3장',
        desc: '한 명의 매니저는 총 3장의 네트워크 초대권을 가지고 있어요. 한정된 자원이기 때문에 자신이 진심으로 믿고 신뢰하는 매니저에게만 사용해야 의미 있게 활용될 수 있습니다.',
        tip: '회원 정보가 공유되는 만큼, 회원 보호 관점에서도 신중하게 발송해 주세요.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      {
        title: '결제액 비율 분배',
        desc: '매칭 1건이 종료되면 결제 금액에 비례해 정산이 발생해요. 매칭 매니저(매칭을 만든 사람)는 결제액의 약 25%, 회원 매니저(각 회원을 등록한 사람)는 결제액의 약 12.5%씩 받게 됩니다.',
